...
static PowerLevelParam g_power_level_params[POWER_LEVEL_COUNT] = {
    /* 45W  */ { 30.0f, 60.0f, 0.01f,  0.000003f, 0.01f, 0.01f, 0.01f },//基准
    /* 50W  */ { 30.0f, 60.0f, 0.009f, 0.000003f, 0.01f, 0.01f, 0.01f },
    /* 55W  */ { 30.0f, 60.0f, 0.008f, 0.000003f, 0.01f, 0.01f, 0.01f },
    /* 60W  */ { 30.0f, 60.0f, 0.007f, 0.000003f, 0.01f, 0.01f, 0.01f },//基准
    /* 65W  */ { 30.0f, 60.0f, 0.003f, 0.000003f, 0.01f, 0.01f, 0.01f },
    /* 70W  */ { 30.0f, 60.0f, 0.003f, 0.000003f, 0.0f, 0.01f, 0.01f },
    /* 75W  */ { 30.0f, 60.0f, 0.001f, 0.0f, 0.01f, 0.01f, 0.01f },
    /* 80W  */ { 30.0f, 60.0f, 0.001f, 0.0f, 0.01f, 0.01f, 0.01f },
    /* 85W  */ { 30.0f, 60.0f, 0.001f, 0.0f, 0.01f, 0.01f, 0.01f },
    /* 90W  */ { 30.0f, 60.0f, 0.001f, 0.0f, 0.01f, 0.01f, 0.01f },
    /* 95W  */ { 30.0f, 60.0f, 0.001f, 0.0f, 0.01f, 0.01f, 0.01f },
    /* 100W */ { 30.0f, 60.0f, 0.001f, 0.0f, 0.01f, 0.01f, 0.01f },
};
